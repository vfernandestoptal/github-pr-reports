...
const userColumns = [
    ...
    { label: 'Avg Reviews', name: 'averageReviewCount', size: 15, map: helpers.toDecimals(2), align: Alignment.Right },
    { label: 'Median Reviews', name: 'medianReviewCount', size: 15, map: helpers.toDecimals(2), align: Alignment.Right },
];
